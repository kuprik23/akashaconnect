      ...
      <Router>
        <Switch>
          ...
          <Route path='/mint'>
            <div className="gradient__bg">
              <Navbar />
              <MintAc mintLimit={acPriceState[0]} preSale={preSale} sale={sale} />
              <MintDCL1 mintLimit={acPriceState[1]} preSale={preSale} sale={sale}/>
              <MintDCL2 mintLimit={acPriceState[2]} preSale={preSale} sale={sale}/>
              <MintDCL3 mintLimit={acPriceState[3]} preSale={preSale} sale={sale}/>
              <MintDCL4 mintLimit={acPriceState[4]} preSale={preSale} sale={sale}/>
              <MintOg/>
              <Footer />
            </div>
          </Route>
