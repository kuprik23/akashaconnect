...
import './mint.css';
import CheckAcPrice from '../../hooks/dataFetcher/dcl2Price'
import CheckAcPrice2 from '../../hooks/dataFetcher/dcl2Price2'
import Dcl2Mint from '../../hooks/dataSender/dcl2Mint'
import { toast } from 'react-toastify';
import { useEffect } from 'react';
import { useWeb3React } from '@web3-react/core';
import CheckAcSupply from '../../hooks/dataFetcher/dcl2Supply'
// import ReactPlayer from 'react-player'
import Loader from '../../hooks/loader';

const MintDCL2 = ({ mintLimit, preSale, sale }) => {
  ...
  return (
    ...
    <div className="gpt3__header section__padding" id="home">
      <div className="gpt3__header-content">
        <h1 className="gradient__text">Mint DCL2</h1>
        ...
        <div className="gpt3__header-content__input d-flex flex-column">
          <div className="row">
            <div className="col-md-7">
              ...
              <button className='px-5 mt-4' id="bt" onClick={() => MintAc()}>MintDCL2</button>
            </div>
          </div>
        </div>
