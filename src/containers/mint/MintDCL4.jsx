...
import CheckAcPrice2 from '../../hooks/dataFetcher/dcl4Price2'
import Dcl2Mint from '../../hooks/dataSender/dcl4Mint'
        ...
        <div className="gpt3__header-content__input d-flex flex-column">
          <div className="row">
            <div className="col-md-7">
              ...
              <button className='px-5 mt-4' id="bt" onClick={() => MintAc()}>MintDCL4</button>
            </div>
          </div>
        </div>
