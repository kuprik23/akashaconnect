...
import CheckAcPrice2 from '../../hooks/dataFetcher/dcl1Price2'
import acMint from '../../hooks/dataSender/acMint'
import dcl1Mint from '../../hooks/dataSender/dcl1Mint'
import { toast } from 'react-toastify';
import { useEffect } from 'react';
import { useWeb3React } from '@web3-react/core';
import CheckAcSupply from '../../hooks/dataFetcher/dcl1Supply'
// import ReactPlayer from 'react-player'

const MintDCL1 = ({ mintLimit, preSale, sale }) => {
    ...
    if (nTokenInpo > 0) {
      ...
      if (nTokenInpo < individualTokenAllowed + 1) {
        ...
        if (aCSupply + nTokenInpo < maxSupply) {
          ...
          toast.error('You can not mint more than 3237 tokens');
        }
      } else {
  ...
  return (
    ...
    <div className="gpt3__header section__padding" id="home">
      <div className="gpt3__header-content">
        <h1 className="gradient__text">Mint DCL1</h1>
